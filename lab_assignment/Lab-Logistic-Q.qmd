...
data$sex_clean <- as.factor(data$sex)
...
**I think I was able to verify the results of the probability, but the log-odds seem to be inverse for me?**
...
ci_lower_lo_age = bage - 1.96 * 0.0798020
ci_upper_lo_age = bage + 1.96 * 0.0798020

ci_lower_or_age = 1.29 - 1.96 * 0.0798020
ci_upper_or_age = 1.29 + 1.96 * 0.0798020

emm_age <- emmeans(m1, "age", type = "response")

```

A one unit increase in age is associated with a decrease in the log-odds of being satisfied with spending on mass transportation by .006, holding all other variables constant. The odds ratio is \_\_\_\_\_ which confirms the \_\_\_\_ relationship implied by the log-odds coefficient. Specifically, for each additional unit of age, the odds of being satisfied with mass transportation spending decrease by a factor of about \_\_\_, or approximately \_\_\_ per unit increase in age, holding other factors constant.
